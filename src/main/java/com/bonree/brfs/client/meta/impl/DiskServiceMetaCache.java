...
public class DiskServiceMetaCache {
    ...
    private ConcurrentHashMap<String, Service> firstServerCache;

    private ConcurrentHashMap<String, String> secondServerCache;
    ...
    public ServiceMetaInfo getFirstServerCache(final String SecondID) {
    ...
    public ServiceMetaInfo getSecondServerCache(final String secondServerId, final int replicatPot) {
        return new ServiceMetaInfo() {
